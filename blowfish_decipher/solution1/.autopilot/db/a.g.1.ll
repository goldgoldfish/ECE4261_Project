...
; [#uses=1]
define internal fastcc i32 @F(i32 %x) nounwind {
  call void @llvm.dbg.value(metadata !{i32 %x}, i64 0, metadata !40), !dbg !41 ; [debug line = 16:31] [debug variable = x]
  %tmp = trunc i32 %x to i16, !dbg !42            ; [#uses=1 type=i16] [debug line = 24:4]
  %d = and i16 %tmp, 255, !dbg !42                ; [#uses=1 type=i16] [debug line = 24:4]
  call void @llvm.dbg.value(metadata !{i16 %d}, i64 0, metadata !44), !dbg !42 ; [debug line = 24:4] [debug variable = d]
  %x.assign = lshr i32 %x, 8, !dbg !46            ; [#uses=1 type=i32] [debug line = 25:4]
  call void @llvm.dbg.value(metadata !{i32 %x.assign}, i64 0, metadata !40), !dbg !46 ; [debug line = 25:4] [debug variable = x]
  %tmp.1 = trunc i32 %x.assign to i16, !dbg !47   ; [#uses=1 type=i16] [debug line = 26:4]
  %c = and i16 %tmp.1, 255, !dbg !47              ; [#uses=1 type=i16] [debug line = 26:4]
  call void @llvm.dbg.value(metadata !{i16 %c}, i64 0, metadata !48), !dbg !47 ; [debug line = 26:4] [debug variable = c]
  %x.assign.1 = lshr i32 %x, 16, !dbg !49         ; [#uses=1 type=i32] [debug line = 27:4]
  call void @llvm.dbg.value(metadata !{i32 %x.assign.1}, i64 0, metadata !40), !dbg !49 ; [debug line = 27:4] [debug variable = x]
  %tmp.2 = trunc i32 %x.assign.1 to i16, !dbg !50 ; [#uses=1 type=i16] [debug line = 28:4]
  %b = and i16 %tmp.2, 255, !dbg !50              ; [#uses=1 type=i16] [debug line = 28:4]
  call void @llvm.dbg.value(metadata !{i16 %b}, i64 0, metadata !51), !dbg !50 ; [debug line = 28:4] [debug variable = b]
  %x.assign.2 = lshr i32 %x, 24, !dbg !52         ; [#uses=1 type=i32] [debug line = 29:4]
  call void @llvm.dbg.value(metadata !{i32 %x.assign.2}, i64 0, metadata !40), !dbg !52 ; [debug line = 29:4] [debug variable = x]
  %a = trunc i32 %x.assign.2 to i16, !dbg !53     ; [#uses=1 type=i16] [debug line = 30:4]
  call void @llvm.dbg.value(metadata !{i16 %a}, i64 0, metadata !54), !dbg !53 ; [debug line = 30:4] [debug variable = a]
  %tmp.3 = zext i16 %a to i32, !dbg !55           ; [#uses=1 type=i32] [debug line = 32:4]
  %S.addr = getelementptr inbounds [4 x [256 x i32]]* @S, i32 0, i32 0, i32 %tmp.3, !dbg !55 ; [#uses=1 type=i32*] [debug line = 32:4]
  %S.load = load i32* %S.addr, align 4, !dbg !55  ; [#uses=2 type=i32] [debug line = 32:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %S.load) nounwind
  %tmp.4 = zext i16 %b to i32, !dbg !55           ; [#uses=1 type=i32] [debug line = 32:4]
  %S.addr.1 = getelementptr inbounds [4 x [256 x i32]]* @S, i32 0, i32 1, i32 %tmp.4, !dbg !55 ; [#uses=1 type=i32*] [debug line = 32:4]
  %S.load.1 = load i32* %S.addr.1, align 4, !dbg !55 ; [#uses=2 type=i32] [debug line = 32:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %S.load.1) nounwind
  %y = add i32 %S.load.1, %S.load, !dbg !55       ; [#uses=1 type=i32] [debug line = 32:4]
  call void @llvm.dbg.value(metadata !{i32 %y}, i64 0, metadata !56), !dbg !55 ; [debug line = 32:4] [debug variable = y]
  %tmp.5 = zext i16 %c to i32, !dbg !57           ; [#uses=1 type=i32] [debug line = 33:4]
  %S.addr.2 = getelementptr inbounds [4 x [256 x i32]]* @S, i32 0, i32 2, i32 %tmp.5, !dbg !57 ; [#uses=1 type=i32*] [debug line = 33:4]
  %S.load.2 = load i32* %S.addr.2, align 4, !dbg !57 ; [#uses=2 type=i32] [debug line = 33:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %S.load.2) nounwind
  %y.1 = xor i32 %S.load.2, %y, !dbg !57          ; [#uses=1 type=i32] [debug line = 33:4]
  call void @llvm.dbg.value(metadata !{i32 %y.1}, i64 0, metadata !56), !dbg !57 ; [debug line = 33:4] [debug variable = y]
  %tmp.6 = zext i16 %d to i32, !dbg !58           ; [#uses=1 type=i32] [debug line = 34:4]
  %S.addr.3 = getelementptr inbounds [4 x [256 x i32]]* @S, i32 0, i32 3, i32 %tmp.6, !dbg !58 ; [#uses=1 type=i32*] [debug line = 34:4]
  %S.load.3 = load i32* %S.addr.3, align 4, !dbg !58 ; [#uses=2 type=i32] [debug line = 34:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %S.load.3) nounwind
  %y.3 = add i32 %S.load.3, %y.1, !dbg !58        ; [#uses=1 type=i32] [debug line = 34:4]
  call void @llvm.dbg.value(metadata !{i32 %y.3}, i64 0, metadata !56), !dbg !58 ; [debug line = 34:4] [debug variable = y]
  ret i32 %y.3, !dbg !59                          ; [debug line = 36:4]
}
...
define void @Blowfish_decipher(i32* %xl, i32* %xr) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{i32* %xl}, i64 0, metadata !60), !dbg !61 ; [debug line = 39:39] [debug variable = xl]
  call void @llvm.dbg.value(metadata !{i32* %xr}, i64 0, metadata !62), !dbg !63 ; [debug line = 39:58] [debug variable = xr]
  call void (...)* @_ssdm_op_SpecInterface(i32* %xr, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !64 ; [debug line = 41:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %xl, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !64 ; [debug line = 41:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !64 ; [debug line = 41:1]
  %Xl = load i32* %xl, align 4, !dbg !66          ; [#uses=1 type=i32] [debug line = 47:4]
  call void @llvm.dbg.value(metadata !{i32 %Xl}, i64 0, metadata !67), !dbg !66 ; [debug line = 47:4] [debug variable = Xl]
  %Xr = load i32* %xr, align 4, !dbg !68          ; [#uses=1 type=i32] [debug line = 48:4]
  call void @llvm.dbg.value(metadata !{i32 %Xr}, i64 0, metadata !69), !dbg !68 ; [debug line = 48:4] [debug variable = Xr]
  br label %1, !dbg !70                           ; [debug line = 50:9]

; <label>:1                                       ; preds = %2, %0
  %Xl.4 = phi i32 [ %Xr, %0 ], [ %Xl.6, %2 ]      ; [#uses=2 type=i32]
  %temp = phi i32 [ %Xl, %0 ], [ %Xr.6, %2 ]      ; [#uses=2 type=i32]
  %i = phi i16 [ 17, %0 ], [ %i.1, %2 ]           ; [#uses=3 type=i16]
  %tmp = icmp sgt i16 %i, 1, !dbg !70             ; [#uses=1 type=i1] [debug line = 50:9]
  br i1 %tmp, label %2, label %3, !dbg !70        ; [debug line = 50:9]

; <label>:2                                       ; preds = %1
  %tmp.7 = sext i16 %i to i32, !dbg !72           ; [#uses=1 type=i32] [debug line = 51:7]
  %P.addr = getelementptr inbounds [18 x i32]* @P, i32 0, i32 %tmp.7, !dbg !72 ; [#uses=1 type=i32*] [debug line = 51:7]
  %P.load = load i32* %P.addr, align 4, !dbg !72  ; [#uses=2 type=i32] [debug line = 51:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %P.load) nounwind
  %Xl.6 = xor i32 %P.load, %temp, !dbg !72        ; [#uses=2 type=i32] [debug line = 51:7]
  call void @llvm.dbg.value(metadata !{i32 %Xl.6}, i64 0, metadata !67), !dbg !72 ; [debug line = 51:7] [debug variable = Xl]
  %tmp.9 = call fastcc i32 @F(i32 %Xl.6), !dbg !74 ; [#uses=1 type=i32] [debug line = 52:12]
  %Xr.6 = xor i32 %tmp.9, %Xl.4, !dbg !74         ; [#uses=1 type=i32] [debug line = 52:12]
  call void @llvm.dbg.value(metadata !{i32 %Xr.6}, i64 0, metadata !69), !dbg !74 ; [debug line = 52:12] [debug variable = Xr]
  call void @llvm.dbg.value(metadata !{i32 %Xl.6}, i64 0, metadata !75), !dbg !76 ; [debug line = 55:7] [debug variable = temp]
  call void @llvm.dbg.value(metadata !{i32 %Xr.6}, i64 0, metadata !67), !dbg !77 ; [debug line = 56:7] [debug variable = Xl]
  call void @llvm.dbg.value(metadata !{i32 %Xl.6}, i64 0, metadata !69), !dbg !78 ; [debug line = 57:7] [debug variable = Xr]
  %i.1 = add i16 %i, -1, !dbg !79                 ; [#uses=1 type=i16] [debug line = 50:28]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !80), !dbg !79 ; [debug line = 50:28] [debug variable = i]
  br label %1, !dbg !79                           ; [debug line = 50:28]

; <label>:3                                       ; preds = %1
  %Xl.0.lcssa = phi i32 [ %temp, %1 ]             ; [#uses=1 type=i32]
  %Xr.0.lcssa = phi i32 [ %Xl.4, %1 ]             ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !75), !dbg !82 ; [debug line = 61:4] [debug variable = temp]
  call void @llvm.dbg.value(metadata !{i32 %Xl.4}, i64 0, metadata !67), !dbg !83 ; [debug line = 62:4] [debug variable = Xl]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !69), !dbg !84 ; [debug line = 63:4] [debug variable = Xr]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 827400743) nounwind
  %Xr.5 = xor i32 %Xl.0.lcssa, 827400743, !dbg !85 ; [#uses=1 type=i32] [debug line = 65:4]
  call void @llvm.dbg.value(metadata !{i32 %Xr.5}, i64 0, metadata !69), !dbg !85 ; [debug line = 65:4] [debug variable = Xr]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 891628582) nounwind
  %Xl.5 = xor i32 %Xr.0.lcssa, 891628582, !dbg !86 ; [#uses=1 type=i32] [debug line = 66:4]
  call void @llvm.dbg.value(metadata !{i32 %Xl.5}, i64 0, metadata !67), !dbg !86 ; [debug line = 66:4] [debug variable = Xl]
  store i32 %Xl.5, i32* %xl, align 4, !dbg !87    ; [debug line = 68:4]
  store i32 %Xr.5, i32* %xr, align 4, !dbg !88    ; [debug line = 69:4]
...
!6 = metadata !{i32 786473, metadata !"blowfish_decipher/blowfish_decrypt_ap_cntrl.c", metadata !"C:\5CUsers\5Ckohara\5CDownloads\5CECE4261_Project-UDP\5CECE4261_Project-UDP", null} ; [ DW_TAG_file_type ]
...
!12 = metadata !{i32 786478, i32 0, metadata !6, metadata !"Blowfish_decipher", metadata !"Blowfish_decipher", metadata !"", metadata !6, i32 39, metadata !13, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @Blowfish_decipher, null, null, metadata !10, i32 40} ; [ DW_TAG_subprogram ]
...
!34 = metadata !{void (i32*, i32*)* @Blowfish_decipher, metadata !35, metadata !36, metadata !37, metadata !38, metadata !39, metadata !33}
...
!42 = metadata !{i32 24, i32 4, metadata !43, null}
!43 = metadata !{i32 786443, metadata !5, i32 17, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!44 = metadata !{i32 786688, metadata !43, metadata !"d", metadata !6, i32 21, metadata !45, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!45 = metadata !{i32 786468, null, metadata !"unsigned short", null, i32 0, i64 16, i64 16, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!46 = metadata !{i32 25, i32 4, metadata !43, null}
!47 = metadata !{i32 26, i32 4, metadata !43, null}
!48 = metadata !{i32 786688, metadata !43, metadata !"c", metadata !6, i32 20, metadata !45, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!49 = metadata !{i32 27, i32 4, metadata !43, null}
!50 = metadata !{i32 28, i32 4, metadata !43, null}
!51 = metadata !{i32 786688, metadata !43, metadata !"b", metadata !6, i32 19, metadata !45, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!52 = metadata !{i32 29, i32 4, metadata !43, null}
!53 = metadata !{i32 30, i32 4, metadata !43, null}
!54 = metadata !{i32 786688, metadata !43, metadata !"a", metadata !6, i32 18, metadata !45, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!55 = metadata !{i32 32, i32 4, metadata !43, null}
!56 = metadata !{i32 786688, metadata !43, metadata !"y", metadata !6, i32 22, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!57 = metadata !{i32 33, i32 4, metadata !43, null}
!58 = metadata !{i32 34, i32 4, metadata !43, null}
!59 = metadata !{i32 36, i32 4, metadata !43, null}
!60 = metadata !{i32 786689, metadata !12, metadata !"xl", metadata !6, i32 16777255, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!61 = metadata !{i32 39, i32 39, metadata !12, null}
!62 = metadata !{i32 786689, metadata !12, metadata !"xr", metadata !6, i32 33554471, metadata !15, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!63 = metadata !{i32 39, i32 58, metadata !12, null}
!64 = metadata !{i32 41, i32 1, metadata !65, null}
!65 = metadata !{i32 786443, metadata !12, i32 40, i32 1, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 47, i32 4, metadata !65, null}
!67 = metadata !{i32 786688, metadata !65, metadata !"Xl", metadata !6, i32 42, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!68 = metadata !{i32 48, i32 4, metadata !65, null}
!69 = metadata !{i32 786688, metadata !65, metadata !"Xr", metadata !6, i32 43, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!70 = metadata !{i32 50, i32 9, metadata !71, null}
!71 = metadata !{i32 786443, metadata !65, i32 50, i32 4, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!72 = metadata !{i32 51, i32 7, metadata !73, null}
!73 = metadata !{i32 786443, metadata !71, i32 50, i32 33, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!74 = metadata !{i32 52, i32 12, metadata !73, null}
!75 = metadata !{i32 786688, metadata !65, metadata !"temp", metadata !6, i32 44, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!76 = metadata !{i32 55, i32 7, metadata !73, null}
!77 = metadata !{i32 56, i32 7, metadata !73, null}
!78 = metadata !{i32 57, i32 7, metadata !73, null}
!79 = metadata !{i32 50, i32 28, metadata !71, null}
!80 = metadata !{i32 786688, metadata !65, metadata !"i", metadata !6, i32 45, metadata !81, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!81 = metadata !{i32 786468, null, metadata !"short", null, i32 0, i64 16, i64 16, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!82 = metadata !{i32 61, i32 4, metadata !65, null}
!83 = metadata !{i32 62, i32 4, metadata !65, null}
!84 = metadata !{i32 63, i32 4, metadata !65, null}
!85 = metadata !{i32 65, i32 4, metadata !65, null}
!86 = metadata !{i32 66, i32 4, metadata !65, null}
!87 = metadata !{i32 68, i32 4, metadata !65, null}
!88 = metadata !{i32 69, i32 4, metadata !65, null}
!89 = metadata !{i32 70, i32 1, metadata !65, null}
