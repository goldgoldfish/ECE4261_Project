; ModuleID = 'C:/Users/kohara/Downloads/ECE4261_Project-UDP/ECE4261_Project-UDP/blowfish_decipher/solution1/.autopilot/db/a.g.bc'
...
define void @Blowfish_decipher(i32* %xl, i32* %xr) nounwind {
  ...
  store i16 17, i16* %i, align 2, !dbg !82        ; [debug line = 50:9]
...
; <label>:9                                       ; preds = %27, %0
  ...
  %12 = icmp sgt i32 %11, 1, !dbg !82             ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:13                                      ; preds = %9
  ...
  %24 = load i32* %Xl, align 4, !dbg !87          ; [#uses=1 type=i32] [debug line = 55:7]
  store i32 %24, i32* %temp, align 4, !dbg !87    ; [debug line = 55:7]
  %25 = load i32* %Xr, align 4, !dbg !88          ; [#uses=1 type=i32] [debug line = 56:7]
  store i32 %25, i32* %Xl, align 4, !dbg !88      ; [debug line = 56:7]
  %26 = load i32* %temp, align 4, !dbg !89        ; [#uses=1 type=i32] [debug line = 57:7]
  store i32 %26, i32* %Xr, align 4, !dbg !89      ; [debug line = 57:7]
  br label %27, !dbg !90                          ; [debug line = 58:4]

; <label>:27                                      ; preds = %13
  %28 = load i16* %i, align 2, !dbg !91           ; [#uses=1 type=i16] [debug line = 50:28]
  %29 = add i16 %28, -1, !dbg !91                 ; [#uses=1 type=i16] [debug line = 50:28]
  store i16 %29, i16* %i, align 2, !dbg !91       ; [debug line = 50:28]
  br label %9, !dbg !91                           ; [debug line = 50:28]

; <label>:30                                      ; preds = %9
  %31 = load i32* %Xl, align 4, !dbg !92          ; [#uses=1 type=i32] [debug line = 61:4]
  store i32 %31, i32* %temp, align 4, !dbg !92    ; [debug line = 61:4]
  %32 = load i32* %Xr, align 4, !dbg !93          ; [#uses=1 type=i32] [debug line = 62:4]
  store i32 %32, i32* %Xl, align 4, !dbg !93      ; [debug line = 62:4]
  %33 = load i32* %temp, align 4, !dbg !94        ; [#uses=1 type=i32] [debug line = 63:4]
  store i32 %33, i32* %Xr, align 4, !dbg !94      ; [debug line = 63:4]
  %34 = load i32* %Xr, align 4, !dbg !95          ; [#uses=1 type=i32] [debug line = 65:4]
  %35 = load i32* getelementptr inbounds ([18 x i32]* @P, i32 0, i32 1), align 4, !dbg !95 ; [#uses=1 type=i32] [debug line = 65:4]
  %36 = xor i32 %34, %35, !dbg !95                ; [#uses=1 type=i32] [debug line = 65:4]
  store i32 %36, i32* %Xr, align 4, !dbg !95      ; [debug line = 65:4]
  %37 = load i32* %Xl, align 4, !dbg !96          ; [#uses=1 type=i32] [debug line = 66:4]
  %38 = load i32* getelementptr inbounds ([18 x i32]* @P, i32 0, i32 0), align 4, !dbg !96 ; [#uses=1 type=i32] [debug line = 66:4]
  %39 = xor i32 %37, %38, !dbg !96                ; [#uses=1 type=i32] [debug line = 66:4]
  store i32 %39, i32* %Xl, align 4, !dbg !96      ; [debug line = 66:4]
  %40 = load i32* %Xl, align 4, !dbg !97          ; [#uses=1 type=i32] [debug line = 68:4]
  %41 = load i32** %1, align 4, !dbg !97          ; [#uses=1 type=i32*] [debug line = 68:4]
  store i32 %40, i32* %41, align 4, !dbg !97      ; [debug line = 68:4]
  %42 = load i32* %Xr, align 4, !dbg !98          ; [#uses=1 type=i32] [debug line = 69:4]
  %43 = load i32** %2, align 4, !dbg !98          ; [#uses=1 type=i32*] [debug line = 69:4]
  store i32 %42, i32* %43, align 4, !dbg !98      ; [debug line = 69:4]
...
!85 = metadata !{i32 786443, metadata !83, i32 50, i32 33, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 52, i32 12, metadata !85, null}
!87 = metadata !{i32 55, i32 7, metadata !85, null}
!88 = metadata !{i32 56, i32 7, metadata !85, null}
!89 = metadata !{i32 57, i32 7, metadata !85, null}
!90 = metadata !{i32 58, i32 4, metadata !85, null}
!91 = metadata !{i32 50, i32 28, metadata !83, null}
!92 = metadata !{i32 61, i32 4, metadata !70, null}
!93 = metadata !{i32 62, i32 4, metadata !70, null}
!94 = metadata !{i32 63, i32 4, metadata !70, null}
!95 = metadata !{i32 65, i32 4, metadata !70, null}
!96 = metadata !{i32 66, i32 4, metadata !70, null}
!97 = metadata !{i32 68, i32 4, metadata !70, null}
!98 = metadata !{i32 69, i32 4, metadata !70, null}
!99 = metadata !{i32 70, i32 1, metadata !70, null}
