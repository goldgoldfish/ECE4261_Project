...
set Library     "hls"
set IPName      "Blowfish_decipher"
set Version     "1.0"
set DisplayName "Blowfish_decipher"
set Revision    "1811301825"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "Blowfish_decipher"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 xl_i W 0x0 "Data signal of xl_i" {{0 32 xl_i W 0 "Bit 31 to 0 Data signal of xl_i"}}} {0x18 xl_o R 0x0 "Data signal of xl_o" {{0 32 xl_o R 0 "Bit 31 to 0 Data signal of xl_o"}}} {0x1c xl_o_ctrl R 0x0 "Control signal of xl_o" {{0 1 xl_o_ap_vld R 0 "Control signal xl_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 xr_i W 0x0 "Data signal of xr_i" {{0 32 xr_i W 0 "Bit 31 to 0 Data signal of xr_i"}}} {0x28 xr_o R 0x0 "Data signal of xr_o" {{0 32 xr_o R 0 "Bit 31 to 0 Data signal of xr_o"}}} {0x2c xr_o_ctrl R 0x0 "Control signal of xr_o" {{0 1 xr_o_ap_vld R 0 "Control signal xr_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 65 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/kohara/Downloads/ECE4261_Project-UDP/ECE4261_Project-UDP/blowfish_decipher/blowfish_decrypt_ap_cntrl.c}
if {$enable_xo_gen} {
