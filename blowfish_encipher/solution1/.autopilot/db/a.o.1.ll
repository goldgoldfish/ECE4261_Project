; ModuleID = 'C:/Users/kohara/Downloads/ECE4261_Project-UDP/ECE4261_Project-UDP/blowfish_encipher/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:1                                       ; preds = %2, %0
  %Xl.2 = phi i32 [ %Xr, %0 ], [ %Xl.6, %2 ]      ; [#uses=2 type=i32]
  %temp = phi i32 [ %Xl, %0 ], [ %Xr.6, %2 ]      ; [#uses=2 type=i32]
  %i = phi i16 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i16]
  %exitcond = icmp eq i16 %i, 16, !dbg !70        ; [#uses=1 type=i1] [debug line = 50:9]
  br i1 %exitcond, label %3, label %2, !dbg !70   ; [debug line = 50:9]

; <label>:2                                       ; preds = %1
  %tmp = sext i16 %i to i32, !dbg !72             ; [#uses=1 type=i32] [debug line = 51:7]
  %P.addr = getelementptr inbounds [18 x i32]* @P, i32 0, i32 %tmp, !dbg !72 ; [#uses=1 type=i32*] [debug line = 51:7]
  ...
  %tmp.8 = call fastcc i32 @F(i32 %Xl.6), !dbg !74 ; [#uses=1 type=i32] [debug line = 52:12]
  %Xr.6 = xor i32 %tmp.8, %Xl.2, !dbg !74         ; [#uses=1 type=i32] [debug line = 52:12]
  call void @llvm.dbg.value(metadata !{i32 %Xr.6}, i64 0, metadata !69), !dbg !74 ; [debug line = 52:12] [debug variable = Xr]
  call void @llvm.dbg.value(metadata !{i32 %Xl.6}, i64 0, metadata !75), !dbg !76 ; [debug line = 54:7] [debug variable = temp]
  call void @llvm.dbg.value(metadata !{i32 %Xr.6}, i64 0, metadata !67), !dbg !77 ; [debug line = 55:7] [debug variable = Xl]
  call void @llvm.dbg.value(metadata !{i32 %Xl.6}, i64 0, metadata !69), !dbg !78 ; [debug line = 56:7] [debug variable = Xr]
  %i.1 = add i16 %i, 1, !dbg !79                  ; [#uses=1 type=i16] [debug line = 50:24]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !80), !dbg !79 ; [debug line = 50:24] [debug variable = i]
  br label %1, !dbg !79                           ; [debug line = 50:24]

; <label>:3                                       ; preds = %1
  %Xl.0.lcssa = phi i32 [ %temp, %1 ]             ; [#uses=1 type=i32]
  %Xr.0.lcssa = phi i32 [ %Xl.2, %1 ]             ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !75), !dbg !82 ; [debug line = 59:4] [debug variable = temp]
  call void @llvm.dbg.value(metadata !{i32 %Xl.2}, i64 0, metadata !67), !dbg !83 ; [debug line = 60:4] [debug variable = Xl]
  call void @llvm.dbg.value(metadata !{i32 %temp}, i64 0, metadata !69), !dbg !84 ; [debug line = 61:4] [debug variable = Xr]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 74911489) nounwind
  %Xr.3 = xor i32 %Xl.0.lcssa, 74911489, !dbg !85 ; [#uses=1 type=i32] [debug line = 63:4]
  call void @llvm.dbg.value(metadata !{i32 %Xr.3}, i64 0, metadata !69), !dbg !85 ; [debug line = 63:4] [debug variable = Xr]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 1953788534) nounwind
  %Xl.3 = xor i32 %Xr.0.lcssa, 1953788534, !dbg !86 ; [#uses=1 type=i32] [debug line = 64:4]
  call void @llvm.dbg.value(metadata !{i32 %Xl.3}, i64 0, metadata !67), !dbg !86 ; [debug line = 64:4] [debug variable = Xl]
  store i32 %Xl.3, i32* %xl, align 4, !dbg !87    ; [debug line = 66:4]
  store i32 %Xr.3, i32* %xr, align 4, !dbg !88    ; [debug line = 67:4]
  ret void, !dbg !89                              ; [debug line = 68:1]
}
...
!73 = metadata !{i32 786443, metadata !71, i32 50, i32 29, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
...
!76 = metadata !{i32 54, i32 7, metadata !73, null}
!77 = metadata !{i32 55, i32 7, metadata !73, null}
!78 = metadata !{i32 56, i32 7, metadata !73, null}
!79 = metadata !{i32 50, i32 24, metadata !71, null}
...
!82 = metadata !{i32 59, i32 4, metadata !65, null}
!83 = metadata !{i32 60, i32 4, metadata !65, null}
!84 = metadata !{i32 61, i32 4, metadata !65, null}
!85 = metadata !{i32 63, i32 4, metadata !65, null}
!86 = metadata !{i32 64, i32 4, metadata !65, null}
!87 = metadata !{i32 66, i32 4, metadata !65, null}
!88 = metadata !{i32 67, i32 4, metadata !65, null}
!89 = metadata !{i32 68, i32 1, metadata !65, null}
